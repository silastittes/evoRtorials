...
height <- read.csv("HeightFall.csv")
...
'author: "Zach Firnett"'.   
Replace "Zach Firnett" with your name (i.e. Marlon Brando). Be sure to leave the double quotes surrounding your name, or your PDF will not knit. 
...
*The mean height of males is larger than that of females*
